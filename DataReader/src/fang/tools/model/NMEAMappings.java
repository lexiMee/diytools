...
public class NMEAMappings {
	  ...
	  public static int getSentenceID(String paramString)
	  {
	    Integer localInteger = (Integer)mappings.get(paramString);
	    if (localInteger == null) {
	      System.err.println("Unable to find sentence type \"" + paramString + "\" in Hashtable");
	      return -1;
	    }
